...
INSERT INTO provinces (prov_id, prov_name, status) VALUES
(1, 'ACEH', 1),
(2, 'SUMATERA UTARA', 1),
(3, 'SUMATERA BARAT', 1),
(4, 'RIAU', 1),
...
GO 
ALTER TABLE [cities] WITH CHECK ADD CONSTRAINT [cities_fk0] FOREIGN KEY ([prov_id]) 
REFERENCES [provinces]([prov_id])
ON UPDATE CASCADE

GO
ALTER TABLE [tiket] WITH CHECK ADD CONSTRAINT [rute_fk1] FOREIGN KEY ([rute_awal]) REFERENCES [cities]([city_id])
ON UPDATE NO ACTION ON DELETE NO ACTION
GO
ALTER TABLE [tiket] CHECK CONSTRAINT [rute_fk1]

GO
ALTER TABLE [tiket] WITH CHECK ADD CONSTRAINT [rute_fk2] FOREIGN KEY ([rute_akhir]) REFERENCES [cities]([city_id])
ON UPDATE NO ACTION ON DELETE NO ACTION
GO
ALTER TABLE [tiket] CHECK CONSTRAINT [rute_fk2]