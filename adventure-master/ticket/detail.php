...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Detil Tiket</h1>
</div>
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Detil Tiket</h6>
    </div>
    <div class="card-body">
        <div class="form-group">
            <label>Nama Pesawat</label>
            <select name="type_tras" class='form-control js2' id='transportasi' disabled>
        ...
        <div class="form-group">
            ...
            <select name="rute_awal" class='form-control js2' disabled>
        ...
        <div class="form-group">
            ...
            <select name="rute_akhir" class='form-control js2' disabled>
        ...
        <div class="form-group">
            ...
            <input type="number" name=' sisa' class='form-control' value='<?= $data['sisa_kursi'] ?>' disabled>
        </div>
